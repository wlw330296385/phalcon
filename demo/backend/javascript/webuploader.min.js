                            ...
                            b.inherits(c, {
                                ...
                                refresh: function() {
                                    var a = this.getRuntime().getContainer(),
                                        ...
                                        e = b.offset();
                                    var o = $(b).parent();
                                    c = o.outerWidth ? o.outerWidth() : o.width();//fix it by vampire
                                    d = o.outerHeight ? o.outerHeight() : o.height();//fix it by vampire
                                    c && d && a.css({
                                        left: "-2px",
                                        bottom: "auto",
                                        right: "auto",
                    ...
                    function(a, b, c) {
                        ...
                        return b.register("DragAndDrop", {
                            ...
                            _dropHandler: function(a) {
                                ...
                                return g && !d.contains(g, a.currentTarget) ? !1 : (b._getTansferFiles(a,
                                    function(a) {
                                        b.trigger("drop", d.map(a,
                                            function(a) {
                                                return new c(f, a)
                                            }))
                            ...
                            _getTansferFiles: function(b, c) {
                                var d, e, f, g, h, i, j, k, l = [],
                                    m = [];
                                for (b = b.originalEvent || b, f = b.dataTransfer, d = f.items, e = f.files, k = !(!d || !d[0].webkitGetAsEntry), i = 0, j = e.length; j > i; i++) g = e[i],
                                    h = d && d[i],
                                    k && h.webkitGetAsEntry().isDirectory ? m.push(this._traverseDirectoryTree(h.webkitGetAsEntry(), l)) : l.push(g);
